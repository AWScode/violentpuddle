...
public MainCookbook(){
  ...
  cookbook.add("grilled cheese");
  cookbook.add("15");
  cookbook.add("two pieces of bread, one slice of cheese, 1oz butter" );
  cookbook.add("place butter in pan, place one slice of bread in pan, place cheese on bread and add next piece of bread on top, flip after golden brown, flip again after golden brown, remove after cheese has melted");
  cookbook(1)= gCheese;

  Recipe macC = new Recipe;
  cookbook.add("mac and cheese");
  cookbook.add("55");
  cookbook.add("4 cups dried macaroni, 1 whole egg, 1/2 stick (4 tablespoons) butter, 1/4 cup all-purpose flour, 2 1/2 cups whole milk, 2 heaping teaspoons dry mustard (more if desired), 1 pound sharp Cheddar, grated (not pre-grated cheese), plus more for baking, Salt" );
